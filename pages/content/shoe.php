...
<?php
    ...
    $query = "SELECT * FROM product WHERE type='shoe'";
    ...
    $query1 = "SELECT * FROM product WHERE type = 'shoe' LIMIT $start, $itemInPage";
    ...
    <nav aria-label='Page navigation example' class='float-end pt-3 d-flex justify-content-center'>
        <ul class='pagination'>
            <a class='page-link' href='?contentmenu=giaybongda&page=".($page > 1 ? $page - 1 : $page)."''><li class='page-item disabled'>Previous</li></a>
    ";
    for($i = 1; $i <= $pageCounter; $i++){
        echo
        "
        <a class='page-link' href='?contentmenu=giaybongda&page=".$i."'><li class='page-item disabled'>".$i."</li></a>
        ";
    }

    echo 
    "
            <a class='page-link' href='?contentmenu=giaybongda&page=".($page < $pageCounter ? $page + 1 : $page)."''><li class='page-item disabled'>Next</li></a>
        </ul> 
    </nav>  
    ";
?>